...
const ConfirmDialog = ({ isConfirmDialogOpen, handleCloseDialog, handleConfirmDelete, texto, encabezado, textoBoton }) => {
    return (
            ...
            <ModalContent>
                ...
                <ModalBody >
                    <div className="p-4 md:p-5 text-center">
                        ...
                        <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">{texto}</h3>
